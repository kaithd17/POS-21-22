...
public class DBAccess {
    ...
    public static void createData() {
        ...
        Set<Airline> airlineSet = DataImport.getAirlines(pathAirlines);
        Set<Airport> airportSet = DataImport.getAirports(pathAirports);

        Set<Aircraft> aircraftSet = DataImport.createAircraftSet(aircraftTypeSet, airlineSet, random);
        //airlineSet.stream().collect(Collectors.toList()).forEach(System.out::println);
        List<Flight> flights = DataImport.createFlights(aircraftSet, airlineSet, airportSet, random);
    ...
    public static void queries() {
        ...
        typedQuery.setParameter("id", 3191);
        ...
        typedQuery1.setParameter("city", "Center West Helipad");
        ...
        typedQuery2.setParameter("name", "Otter Lake Airport");
        ...
        typedQuery3.setParameter("city", "Otter Lake Airport");
        ...
        typedQuery4.setParameter("type", "BRASHER");
